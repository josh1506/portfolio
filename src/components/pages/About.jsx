    ...
    const skillList = [
        {
            ...
            list: [
                { name: "Python", knowledge: 73 },
                { name: "Django", knowledge: 62 },
                { name: "JavaScript", knowledge: 68 },
                { name: "React", knowledge: 56 },
            ],
        },
        {
        ...
        },
        {
            title: "Analytics",
            list: [
                { name: "MySQL", knowledge: 75 },
                { name: "Tableau", knowledge: 60 },
                { name: "Excel", knowledge: 78 },
            ],
        },
        {
            ...
            list: [
                ...
                { name: "React Native", knowledge: 30 },
                { name: "HTML", knowledge: 65 },
                { name: "CSS", knowledge: 60 },
                { name: "Bootstrap", knowledge: 55 },
                { name: "React Bootstrap", knowledge: 45 },
                { name: "Material UI", knowledge: 46 },
                { name: "Jinja", knowledge: 43 },
                { name: "Django Template Language", knowledge: 43 },
            ],
        },
        {
            title: "Cloud/Database",
            list: [
                { name: "PostgreSQL", knowledge: 60 },
                { name: "MongoDB", knowledge: 55 },
                { name: "Google Cloud Platform", knowledge: 20 },
                { name: "Amazon Web Services", knowledge: 30 },
                { name: "Amazon RDS", knowledge: 30 },
                { name: "Amazon S3", knowledge: 30 },
                { name: "SQL", knowledge: 55 },
                { name: "NoSQL", knowledge: 50 },
                { name: "Firebase", knowledge: 40 },
            ],
        },
        {
            title: "Other Skills",
            list: [
                { name: "GitHub", knowledge: 65 },
                { name: "Git", knowledge: 50 },
                { name: "Heroku", knowledge: 45 },
                { name: "Vercel", knowledge: 40 },
                { name: "Netlify", knowledge: 40 },
                { name: "Bitbucket", knowledge: 40 },
                { name: "Dialogflow", knowledge: 30 },
            ],
        },
    ];
