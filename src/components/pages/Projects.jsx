...
const Projects = (props) => {
    const [projectList, setProjectList] = useState([
        ...
        },
        {
            ...
            description:
                "A web base donation platform for the province of Pampanga.",
            onHover: false,
    ...
    const handleMouseEnter = (selectedProject) => {
        const projectListDisableHover = projectList.map((project) => {
            return { ...project, onHover: false };
        });
        const newProjectList = projectListDisableHover.map((project) =>
            project.id === selectedProject.id
                ? { ...project, onHover: true }
                : project
        );
    ...
    return (
        <React.Fragment>
            ...
            >
                <motion.h1 className="page-title" variants={animateTitle}>
                    Projects
                </motion.h1>
                <motion.div
                    ...
                    {projectList.map((project) => (
                        ...
                        >
                            ...
                            >
                                <img
                                    src={project.img}
                                    alt={`${project.name}_img.png`}
                                    width="350px"
                                />
                            </a>
                            <div className="project-detail-container">
                                {!project.onHover && (
                                    <motion.div variants={animateProjectDetail}>
                                ...
                                {project.onHover && (
                                    <motion.div
                                        ...
                                        variants={animateProjectDetail}
                                    >
                                        {project.techStack.map((tech) => (
                                            <motion.p
                                                variants={animateTechStack}
                                                key={tech.id}
